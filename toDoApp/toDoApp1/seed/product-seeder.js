...
var products = [
    new Product({
    imagePath: 'https://en.wikipedia.org/wiki/Game_of_Thrones#/media/File:Game_of_Thrones_title_card.jpg',
    ...
    new Product({
        imagePath: 'https://en.wikipedia.org/wiki/Breaking_Bad#/media/File:Breaking_Bad_title_card.png',
        title: 'Breaking Bad',
    ...
    new Product({
        imagePath: 'https://en.wikipedia.org/wiki/Friends#/media/File:Friends_logo.svg',
        title: 'F.R.I.E.N.D.S',
    ...
    new Product({
        imagePath: 'https://en.wikipedia.org/wiki/The_Wire_(season_1)#/media/File:The_Wire_-_Season_1.jpg',
        title: 'The Wire',
    ...
    new Product({
        imagePath: 'https://en.wikipedia.org/wiki/House_of_Cards_(season_1)#/media/File:House_of_Cards_season_1.png',
